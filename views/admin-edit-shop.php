<p class="form-field form-field-wide wc-dropshipping" style="margin-top:50px">&nbsp;</p>
<h3><?php esc_html_e('Dropshipping', 'topdrop'); ?></h3>
<div class="form-dropship-information">
    <p class="form-field form-field-wide validate-required" id="topdrop_name_field" data-priority="">
    ...
    <p class="form-field form-field-wide" id="topdrop_phone_field" data-priority="">
